...
const { DOANE_SB_API_TOKEN, DOANE_PR_API_TOKEN } = process.env;
const SB_BASE = 'https://sandbox.tinypass.com/api/v3';
const PR_BASE = 'https://api.tinypass.com/api/v3';
const sb_aid = 'ewJNmU7sbo';
const pr_aid = 'HvKpR8HLhx';

// get custom fields schema
async function getCustomFields() {
    const res = await axios.get(`${SB_BASE}/publisher/customFields/get?api_token=${DOANE_SB_API_TOKEN}&aid=${sb_aid}`);
